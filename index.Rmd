...
.pull-left[![:scale 79%; position: relative; left: 4vh](images/cbd/fao2020.png)]

--

.pull-right[![:scale 90%; position: relative; border: 2px solid #555](images/cbd/ipbes.png)]
...
> **.font120[Plus d'actions pour ralentir la perte de biodiversité]**

--

<br><br>

>**.font120[Importance des suivis de biodiversité]**
...
![:scale 29%; position: relative; left: 6vh; top: 2vh](images/biodiv/biodiv_dim/dna.png)

--

![:scale 30%; position: relative; left: 38vh; top: -21vh](images/biodiv/biodiv_dim/composition.png)

--

![:scale 45%; position: relative; left: 4vh; top: -18vh](images/biodiv/biodiv_dim/interactions.png)

--

![:scale 20%; position: relative; left: 48vh; top: -35vh](images/biodiv/biodiv_dim/services.png)
...
<br><br>
.center[![:scale 80%](images/biodiv/glo_loc/global.png)]
...
<br><br>
.center[![:scale 80%](images/biodiv/glo_loc/local.png)]
...
<br><br>
.center[![:scale 80%](images/biodiv/glo_loc/local_services.png)]
...
<br><br><br><br>
.center[![:scale 75%](images/ebv/harmoniser/harm1.png)]
...
<br><br><br><br>
.center[![:scale 75%](images/ebv/harmoniser/harm2.png)]
...
.pull-left[
  ![:scale 60%; position: relative; left: 12vh](images/ebv/cond/cond1.png)
]

--

.pull-right[
  ![:scale 40%; position: relative; left: 3vh](images/ebv/cond/cond2.png)

  ![:scale 40%; position: relative; left: 15vh](images/ebv/cond/cond3.png)
]

--

.center[
  ![:scale 55%; position: relative; left: -13vh; top: -13vh](images/ebv/cond/cond4.png)
]
...
.center[
  ![:scale 86%](images/ebv/class/class1.png)
]
...
.center[
  ![:scale 86%](images/ebv/class/class2.png)
]
...
.center[
  ![:scale 86%](images/ebv/class/class3.png)
]
...
.center[
  ![:scale 86%](images/ebv/class/class4.png)
]
...
.center[
  ![:scale 86%](images/ebv/class/class5.png)
]
...
.center[
  ![:scale 86%](images/ebv/class/class6.png)
]
...
.center[
  ![:scale 86%](images/ebv/class/class7.png)
]
...
.center[
  ![:scale 45%](images/ebv/cube/cube.png)
]
...
.pull-rigth[
  ...
  ![:scale 40%; position: relative; left: 6vh](images/indicators/time_series1.png)
]
...
.pull-rigth[
  ...
  ![:scale 40%; position: relative; left: 6vh](images/indicators/time_series2.png)
]
...
.pull-left[
  ![:scale 85%; position: relative; left: 5vh](images/cbd/cbd.png)
]

.pull-right[
  ![:scale 60%; position: relative; left: 5vh](images/cbd/aichi/aichi_cbd.png)
]
...
.center[
  .font160[Des **dizaines** d'indicateurs]
]
...
.center[
  ![:scale 85%](images/canada/lpi_can.png)
]
...
- .font120[Aucun suivi de biodiversité]
...
- .font120[Manque de données (e.g. suivis à long terme)]
